...
export class AppComponent implements OnInit {
  ...
  serverUrl : string = "https://3000-b4117335-fe55-4b4d-8f2b-660da2d394bb.ws-eu01.gitpod.io";
  ...
  cambiaFoglio(foglio) : boolean
  {
    ...
    this.obsCiVett = this.http.get<Ci_vettore[]>(`https://3000-b4117335-fe55-4b4d-8f2b-660da2d394bb.ws-eu01.gitpod.io/ci_vettore/${val}`);  //Fa una get per ricavare dati da una pagina specifiacata
  ...
  all() : boolean
  {
    ...
    this.allData = this.http.get<GeoFeatureCollection>(`https://3000-b4117335-fe55-4b4d-8f2b-660da2d394bb.ws-eu01.gitpod.io/all`);
